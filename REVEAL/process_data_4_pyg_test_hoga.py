...
def main(op, lmsb):
    source_dir = f"./data_4_ml_train_{op}_{lmsb}"
    target_dir_train = f"./dataset_ml_train_{op}_{lmsb}_hoga"
    source_dir_test = f"./data_4_ml_test_{op}_{lmsb}"
    target_dir_test = f"./dataset_ml_test_{op}_{lmsb}_hoga"
