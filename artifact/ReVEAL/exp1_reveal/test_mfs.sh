...
input_file="./pred_stage3_mfs2_U_128.csv"
# input_file="./pred_test.csv"
mfs_dir="../../AMulet2.0_artifact/128_mfs"
default_dir="../../AMulet2.0_artifact/128_default"
output_dir1="./cnf_mfs_128"
output_dir2="./mfs_128_result"
...
process_row() {
    ...
    local aig_file="$mfs_dir/$col1.aig"
    ...
    # AIGabc
    if [[ -f "$aig_file1" ]]; then
        add_command "./abc -c \"miter '$aig_file' '$aig_file1'; &get; &glucose2;\""
    ...
    if [[ -f "$aig_file2" ]]; then
        add_command "./abc -c \"miter '$aig_file' '$aig_file2'; &get; &glucose2;\""
    ...
    if [[ -f "$aig_file3" ]]; then
        add_command "./abc -c \"miter '$aig_file' '$aig_file3'; &get; &glucose2;\""
