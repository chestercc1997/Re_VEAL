...
output_dir="./resyn3/resyn3_64_result_fraig1" # 
...
for aig_file_path in "$resyn3_dir"/*.aig; do
    ...
    #  timeout "TO" ./abc 
    cmd="bash -c 'timeout 3600 ./abc -c \"miter $aig_file_path $matched_file;&get;&fraig -x -v;&ps;time\" > \"$output_file1\"; exit_code=\$?; if [ \$exit_code -eq 124 ]; then echo \"TO\" > \"$output_file1\"; fi'"
