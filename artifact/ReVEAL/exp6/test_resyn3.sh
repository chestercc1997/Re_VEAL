...
input_file="../exp7/pred_stage3_resyn3_Test.csv"
# input_file="../our/pred_test.csv"
resyn3_dir="../32_resyn3"
default_dir="../32_default"
output_dir1="./cnf_resyn3_32"
output_dir2="./resyn3_32_resultp"
...
process_row() {
    ...
    local aig_file="$resyn3_dir/$col1.aig"
    ...
    # AIGabc
    if [[ -f "$aig_file1" ]]; then
        add_command "./abc -c \"miter -n '$aig_file' '$aig_file1';&get;&fraig -y -v;&ps;time\""
    ...
    if [[ -f "$aig_file2" ]]; then
        add_command "./abc -c \"miter -n '$aig_file' '$aig_file2';&get;&fraig -y -v;&ps;time\""
    ...
    if [[ -f "$aig_file3" ]]; then
        add_command "./abc -c \"miter -n '$aig_file' '$aig_file3';&get;&fraig -y -v;&ps;time\""
